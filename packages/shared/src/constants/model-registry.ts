...
export const MODEL_REGISTRY: Record<AIModel, ModelConfig> = {
  ...
  [AIModel.SORA]: {
    ...
    label: "OpenAI Sora",
    description:
      "Terbaik untuk durasi panjang, fisika kompleks, dan penceritaan hiper-realistis.",
  ...
  [AIModel.GEN3]: {
    ...
    label: "Runway",
    description:
      "Sangat baik untuk bidikan sinematik realistis dan kontrol kamera presisi.",
    supports: ["VIDEO_GEN"],
  },
  [AIModel.VEO]: {
    id: AIModel.VEO,
    label: "Google Veo",
    description:
      "Generasi 1080p+ definisi tinggi dengan pemahaman mendalam istilah sinematik.",
    supports: ["VIDEO_GEN", "TIMELAPSE"],
  },
  [AIModel.LUMA]: {
    id: AIModel.LUMA,
  ...
  [AIModel.MIDJOURNEY_VIDEO]: {
    ...
    description:
      'Dioptimalkan untuk menghasilkan "Frame Pertama" sempurna untuk image-to-video.',
    supports: ["VIDEO_GEN"],
  },
  ...
  [AIModel.DALLE3]: {
    ...
    label: "DALL-E",
    description:
      "Terbaik untuk mengikuti instruksi presisi dan rendering teks.",
    supports: ["IMAGE"],
  },
  [AIModel.STABLE_DIFFUSION_XL]: {
    ...
    description:
      "Open source, dapat dikontrol via ControlNet (prompt dioptimalkan untuk SDXL).",
    supports: ["IMAGE"],
  },
  [AIModel.FLUX]: {
    id: AIModel.FLUX,
