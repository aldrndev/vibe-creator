...
export const YOUTUBE_DEGRADED_SNAPSHOT_ITEMS: readonly ScrapedItem[] = [
  {
    ...
    rank: 1,
    metrics: { traffic: '5M+', duration: 'PT8M45S' },
  ...
  },
  {
    ...
    rank: 2,
    metrics: { traffic: '2.5M+', duration: 'PT15M30S' },
    type: TRENDING_TYPES.VIDEO,
  ...
  },
  {
    ...
    rank: 3,
    metrics: { traffic: '1.8M+', duration: 'PT45M12S' },
    type: TRENDING_TYPES.VIDEO,
    category: 'Gaming',
  ...
  },
  {
    ...
    rank: 4,
    metrics: { traffic: '1.2M+', duration: 'PT4M20S' },
    type: TRENDING_TYPES.VIDEO,
    category: 'Music',
  ...
  },
  {
    ...
    rank: 5,
    metrics: { traffic: '900K+', duration: 'PT12M05S' },
    type: TRENDING_TYPES.VIDEO,
  ...
  },
  {
    ...
    rank: 6,
    metrics: { traffic: '3M+', duration: 'PT1H05M10S' },
    type: TRENDING_TYPES.VIDEO,
  ...
  },
  {
    ...
    rank: 7,
    metrics: { traffic: '1.5M+', duration: 'PT2H15M30S' },
    type: TRENDING_TYPES.VIDEO,
    category: 'Gaming',
