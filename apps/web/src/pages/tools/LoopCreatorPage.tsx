                  ...
                  <div className={"transition-all space-y-6"}>
                    ...
                    <div className="mt-4">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        *Otomatis menambahkan background blur jika rasio tidak
                        sesuai
                      </p>
                    </div>
                    ...
                    {loopMode === "gif" && endMs - startMs > 10000 && (
                      <div className="mt-3 p-2 bg-warning/10 border border-warning/20 rounded-md flex items-center gap-2">
                        ...
                        <p className="text-xs text-warning-700">
                          Durasi GIF {((endMs - startMs) / 1000).toFixed(1)}s
                          cukup panjang. Ukuran file mungkin sangat besar.
                        </p>
                      </div>
                    )}
                            ...
                            (() => {
                              ...
                              return (
                                <div className="space-y-2">
                                  ...
                                  >
                                    Sistem akan mengulang sebanyak{" "}
                                    <b>{loopCount}x</b>{" "}
                                    {loopCount > 5000 && "(Terlalu Banyak!)"}{" "}
                                    untuk mencapai durasi ini.
                                  </p>
                                </div>
                              );
                            })()
                            ...
                            <div>
                              {loopMode === "boomerang" && (
                                <div className="mb-2 p-2 bg-primary/10 rounded-md text-xs text-primary">
                                  <b>Mode Boomerang:</b> Total Putar disesuaikan
                                  agar durasi maksimal 1 Menit.
                                </div>
                              )}
