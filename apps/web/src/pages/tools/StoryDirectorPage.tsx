...
export function StoryDirectorPage() {
  ...
  useEffect(() => {
    if (projectId) {
      ...
      // Initialize new session if no ID
  ...
  return (
    <div className="h-[calc(100vh-80px)] flex flex-col gap-6 p-4">
      {/* Header */}
      <div className="flex justify-between items-center bg-content1/50 p-4 rounded-xl border border-divider/50 backdrop-blur-md sticky top-0 z-20">
        <div>
        ...
        <div className="flex gap-2">
          <Button variant="flat" startContent={<LayoutTemplate size={18} />}>
            Templates
          </Button>
        </div>
      </div>
