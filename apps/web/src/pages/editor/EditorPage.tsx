...
export function EditorPage() {
  ...
  const onExportClick = useCallback(() => {
    ...
    if (clips.length === 0) {
      // TODO: Show inline error in ExportModal or use alert
      return;
    }
  ...
  const handleDeleteClip = () => {
    if (!selectedClipId) {
      // No clip selected - button is already disabled or action silently exits
      return;
    }
  ...
  const handleDuplicateClip = () => {
    if (!selectedClipId) {
      // No clip selected - button is already disabled
      return;
    }
  ...
  const handleSplitClip = () => {
    ...
    if (!clipToSplit) {
      // No clip at playhead - visual feedback is the playhead position itself
      return;
    }
    ...
    // Clip split successful - visual feedback is the timeline change
  };
          ...
          <ModalBody className="space-y-4">
            ...
            {urlInput &&
              ...
              (() => {
                ...
                //             YouTube Download Terbatas
                //           </p>
                //           <p className="text-sm text-foreground/70 mb-2">
                //             Google memblokir download otomatis dari YouTube.
                //             Sebagai alternatif:
                //           </p>
                //           <ul className="text-sm text-foreground/60 list-disc list-inside space-y-1">
                //             <li>
                //               Gunakan <strong>TikTok</strong> atau{" "}
                //               <strong>Instagram</strong> (100% work)
                //             </li>
                //             <li>
                //               Download manual dari YouTube lalu upload file
                //             </li>
                //           </ul>
                //         </div>
                //       </div>
