...
export const EditorMainArea = () => {
  type MobileTab = 'assets' | 'preview' | 'inspector';
  type SidebarTab = 'assets' | 'inspector';
  ...
  const handleDuplicateClip = () => {
    ...
    const lastClipEnd =
      videoTrack.clips.length > 0 ? Math.max(...videoTrack.clips.map((c) => c.endMs)) : 0;
  ...
  return (
    <TooltipProvider>
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden relative bg-background">
        ...
        <div
          className={cn(
            'flex-1 flex-col min-w-0 min-h-0 bg-muted/20 order-2 md:order-1',
        ...
        >
          ...
          <div className="flex-1 flex flex-col min-h-0 border-b border-border relative">
            ...
            <div className="hidden md:flex items-center border-b border-border shrink-0">
              <button
                type="button"
          ...
          <div className="h-64 shrink-0 relative hidden md:block">
            <Timeline />
          </div>
      ...
      <div className="md:hidden h-14 border-t border-border bg-background flex items-center justify-around shrink-0 z-50">
        {[
          ...
          <Button
            ...
            className={cn(
              ...
              mobileTab === tab.id ? 'text-primary bg-primary/5' : 'text-muted-foreground',
            )}
            onClick={() => {
              ...
              if (tab.id === 'assets' || tab.id === 'inspector') {
                setSidebarTab(tab.id as SidebarTab);
              }
            }}
          >
            <tab.icon size={18} />
