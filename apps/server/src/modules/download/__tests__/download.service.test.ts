...
describe("downloadService", () => {
  ...
  describe("getJobStatus", () => {
    ...
    it("should throw error for non-existent job", async () => {
      ...
      // Act & Assert
      await expect(
        downloadService.getJobStatus("nonexistent", "user-123")
      ).rejects.toThrow("Download job not found");
    });
  ...
  describe("deleteJob", () => {
    ...
    it("should throw error for non-existent job", async () => {
      ...
      // Act & Assert
      await expect(
        downloadService.deleteJob("nonexistent", "user-123")
      ).rejects.toThrow("Download job not found");
  ...
  describe("getHistory", () => {
    it("should return download history for user", async () => {
      ...
      // Act
      const result = await downloadService.getHistory("user-123");
